...
static cv::Mat* photo;
static int Hue_min = 40;
static int Hue_max = 80;
static int Saturation_min = 50;
static int Saturation_max = 255;
static int Value_min = 30;
...
static void on_trackbar(int, void*)
{
    ...
    cv::setTrackbarMax("Hue_min", WINDOWS_NAME, Hue_max);
    ...
    cv::inRange( photo_hsv, cv::Scalar(Hue_min, Saturation_min, Value_min), cv::Scalar(Hue_max, Saturation_max, Value_max), hsv_mask);
...
void start_green_calib(cv::Mat* captured_photo )
{
    ...
    libconfig::Setting &red_config = root.add("green", libconfig::Setting::TypeGroup);
    ...
    cfg.writeFile("green.cfg");
    cout << " last green configuration writen to green.cfg file" << endl;
}